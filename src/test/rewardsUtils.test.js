...
describe("calculateRewardPoints", () => {
  ...
  test("should correctly calculate points for an amount over $100 (fractional)", () => {
    ...
    expect(calculateRewardPoints(100.01)).toBe(50.02000000000001);
  });
  ...
  test("should correctly calculate points for an amount between $50 and $100 (fractional)", () => {
    expect(calculateRewardPoints(75.5)).toBe(25.5);
    expect(calculateRewardPoints(50.01)).toBe(0.00999999999999801);
  });
